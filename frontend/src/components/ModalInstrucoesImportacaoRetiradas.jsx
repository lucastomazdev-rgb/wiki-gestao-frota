...
export default function ModalInstrucoesImportacaoRetiradas({ isOpen, onClose, onConfirm, unidades = [] }) {
  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-center justify-center p-4" role="dialog" aria-modal="true">
      ...
      <div className="bg-white w-full max-w-2xl rounded-3xl shadow-[0_25px_60px_rgba(0,0,0,0.25)] relative z-10 flex flex-col max-h-[90vh] overflow-hidden border border-slate-200 animate-in zoom-in-95 duration-200">
        <div className="bg-gradient-to-r from-orange-50 to-red-50 px-6 py-4 border-b border-orange-100 flex items-center justify-between shrink-0">
          <div className="flex items-center gap-3">
            <div className="p-2.5 bg-orange-100 text-orange-600 rounded-xl border border-orange-200">
              <Upload size={20} />
            </div>
            <div>
              <h3 className="text-lg font-black text-slate-800 tracking-tight">Importar Retiradas</h3>
              <p className="text-[9px] text-orange-600 font-black uppercase tracking-widest mt-1">Padrão de Arquivo CSV</p>
            </div>
          </div>
        ...
        <div className="p-6 overflow-y-auto custom-scrollbar flex-1">
              ...
              <table className="w-full text-left border-collapse whitespace-nowrap">
                <thead>
                  <tr className="bg-slate-100/50 text-slate-700 text-xs border-b border-slate-200">
                    ...
                    <th className="p-3 font-black">Data da Baixa</th>
                ...
                <tbody className="divide-y divide-slate-100 text-[11px] font-medium text-slate-600">
                  <tr className="bg-slate-50/50">
                    ...
                    <td className="p-3 border-l border-slate-200/50">Retirado</td>
                  ...
                  <tr className="bg-white">
                    ...
                    <td className="p-3 border-l border-slate-200/50">Roubado/Não Recuperado</td>
          ...
          <div className="bg-slate-50 border border-slate-200 p-4 rounded-xl mb-6">
            ...
            <div className="flex flex-col gap-3">
              <label className="flex items-center gap-3 cursor-pointer group">
                ...
                />
                <span className="text-sm text-slate-700 font-medium group-hover:text-orange-700 transition-colors">
                  <strong className="font-black">Toda a base:</strong> processa as baixas válidas encontradas no arquivo.
                </span>
              </label>
              ...
              <label className="flex gap-3 cursor-pointer group items-start">
                ...
                <div className="flex-1">
                  <span className="text-sm text-slate-700 font-medium group-hover:text-orange-700 transition-colors">
                    <strong className="font-black">Somente uma unidade:</strong> processa apenas baixas vinculadas à unidade escolhida abaixo.
                  </span>
                  {syncMode === 'unidade' && (
                    <div className="mt-3">
                      <select 
                        ...
                        className="w-full sm:w-2/3 p-2 border border-slate-300 rounded-lg text-sm bg-white focus:ring-2 focus:ring-orange-500/20 focus:border-orange-500 outline-none"
                      >
          ...
          <div className="bg-slate-50 border border-slate-200 p-4 rounded-xl mb-6">
            ...
            <div className="flex flex-col gap-3">
              <label className="flex items-start gap-3 cursor-pointer group">
                <input type="radio" name="syncUpdateModeRetiradas" value="incremental" className="mt-0.5 w-4 h-4 text-orange-600 focus:ring-orange-500 border-slate-300" checked={syncUpdateMode === 'incremental'} onChange={() => { setSyncUpdateMode('incremental'); setConfirmMirror(false); }} />
                <span className="text-sm text-slate-700 font-medium group-hover:text-orange-700 transition-colors">
                  <strong className="font-black">Atualização incremental:</strong> cria e atualiza baixas, sem apagar placas ausentes no arquivo.
                </span>
              </label>
              <label className="flex items-start gap-3 cursor-pointer group">
                <input type="radio" name="syncUpdateModeRetiradas" value="espelho" className="mt-0.5 w-4 h-4 text-red-600 focus:ring-red-500 border-slate-300" checked={syncUpdateMode === 'espelho'} onChange={() => setSyncUpdateMode('espelho')} />
                <span className="text-sm text-slate-700 font-medium group-hover:text-red-700 transition-colors">
                  <strong className="font-black">Substituir base pelo arquivo:</strong> remove baixas ausentes no CSV dentro do escopo escolhido.
                </span>
              </label>
          ...
          <div className="bg-orange-50 border border-orange-200 p-4 rounded-xl mt-6 shadow-sm">
        ...
        <div className="p-6 pt-4 bg-slate-50 border-t border-slate-100 shrink-0">
          <label className="flex items-center gap-3 cursor-pointer group mb-6 p-1">
            <div className="relative flex items-center justify-center shrink-0">
              <input 
                type="checkbox" 
                className="peer appearance-none w-5 h-5 border-2 border-slate-300 rounded-[6px] checked:bg-orange-500 checked:border-orange-500 transition-all cursor-pointer shadow-sm hover:border-orange-400"
            ...
            <span className="text-sm font-bold text-slate-700 group-hover:text-orange-700 transition-colors select-none">
          ...
          <div className="flex gap-3 pt-0">
            ...
            <button 
              ...
              className="flex-1 py-3.5 bg-gradient-to-r from-orange-500 to-red-600 hover:from-orange-600 hover:to-red-700 text-white font-extrabold text-sm rounded-xl transition-all shadow-md hover:shadow-lg disabled:opacity-40 disabled:cursor-not-allowed flex items-center justify-center gap-2"
            >
